...
const BOSS_BACK_IMAGE_CONFIGS: Record<number, BossImageStyleConfig> = {
  ...
  23: { pc: { height: '100%', width: '100%' }, 
   mobile: { height: '160%', width: '160%', position: 'absolute', top: '-30%', left: '-33%', transform: 'translate(-50%,-50%);' } },
  ...
  30: { pc: { height: '160%', width: '160%', position: 'absolute', top: '0%', left: '-30%', transform: 'translate(-50%,-50%);'},
   mobile: { height: '160%', width: '160%', position: 'absolute', top: '0%', left: '-10%', transform: 'translate(-50%,-50%);' } },
  ...
  34: { pc: { height: '100%', width: '100%' }, 
  mobile: { height: '120%', width: '120%' , position: 'absolute', top: '0%', left: '0%', transform: 'translate(-50%,-50%);' } },
...
const BOSS_BATTLE_IMAGE_CONFIGS: Record<number, BossImageStyleConfig> = {
  ...
  21: { pc: { height: '80%', width: '80%' }, mobile: { height: '80%', width: '80%' } },
  22: { pc: { height: '100%', width: '100%' }, mobile: { height: '100%', width: '100%' } },
  23: { pc: { height: '100%', width: '100%' },
   mobile: { height: '140%', width: '140%', position: 'absolute', top: '-20%', left: '-23%', transform: 'translate(-50%,-50%);' } },
  24: { pc: { height: '160%', width: '100%', position: 'absolute', top: '0%', left: '0%', transform: 'translate(-50%,-50%);' },
   mobile: { height: '120%', width: '100%', position: 'absolute', top: '10%', left: '0%', transform: 'translate(-50%,-50%);' } },
  25: { pc: { height: '100%', width: '100%' }, mobile: { height: '80%', width: '80%' } },
  26: { pc: { height: '100%', width: '100%' }, mobile: { height: '80%', width: '80%' } },
  ...
  35: { pc: { height: '100%', width: '80%' }, mobile: { height: '80%', width: '80%' } },
  36: { pc: { height: '120%', width: '120%', position: 'absolute', top: '-10%', left: '-10%', transform: 'translate(-50%,-50%);'},
   mobile: { height: '120%', width: '120%' , position: 'absolute', top: '-10%', left: '-10%', transform: 'translate(-50%,-50%);' }},
  37: { pc: { height: '120%', width: '120%', position: 'absolute', top: '0%', left: '-10%', transform: 'translate(-50%,-50%);'},
   mobile: { height: '120%', width: '120%' , position: 'absolute', top: '0%', left: '-10%', transform: 'translate(-50%,-50%);' }},
...
const BOSS_SIDEBAR_IMAGE_CONFIGS: Record<number, BossImageStyleConfig> = {
  ...
  13: { pc: { height: '70%', width: '70%' }, mobile: { height: '80%', width: '80%' } },
  14: { pc: { height: '70%', width: '70%' }, mobile: { height: '80%', width: '80%' } },
  15: { pc: { height: '80%', width: '80%' }, mobile: { height: '80%', width: '80%' } },
  16: { pc: { height: '70%', width: '70%' }, mobile: { height: '80%', width: '80%' } },
  17: { pc: { height: '80%', width: '80%' }, mobile: { height: '80%', width: '80%' } },
  18: { pc: { height: '70%', width: '70%' }, mobile: { height: '80%', width: '80%' } },
  19: { pc: { height: '70%', width: '70%' }, mobile: { height: '80%', width: '80%' } },
  20: { pc: { height: '70%', width: '100%' }, mobile: { height: '100%', width: '100%' } },
  21: { pc: { height: '80%', width: '80%' }, mobile: { height: '80%', width: '80%' } },
  22: { pc: { height: '80%', width: '80%' }, mobile: { height: '100%', width: '100%' } },
  23: { pc: { height: '100%', width: '100%' }, mobile: { height: '100%', width: '100%' } },
  24: { pc: { height: '50%', width: '50%' }, mobile: { height: '100%', width: '100%' } },
  25: { pc: { height: '60%', width: '60%' }, mobile: { height: '60%', width: '60%' } },
  26: { pc: { height: '60%', width: '60%' }, mobile: { height: '60%', width: '60%' } },
  27: { pc: { height: '70%', width: '70%' }, mobile: { height: '60%', width: '60%' } },
  28: { pc: { height: '50%', width: '50%' }, mobile: { height: '60%', width: '60%' } },
  29: { pc: { height: '50%', width: '50%' }, mobile: { height: '60%', width: '60%' } },
  30: { pc: { height: '60%', width: '80%' }, mobile: { height: '100%', width: '100%' } },
  31: { pc: { height: '60%', width: '80%' }, mobile: { height: '60%', width: '60%' } },
  32: { pc: { height: '60%', width: '70%' }, mobile: { height: '60%', width: '60%' } },
  33: { pc: { height: '60%', width: '80%' }, mobile: { height: '60%', width: '60%' } },
  34: { pc: { height: '60%', width: '100%' }, mobile: { height: '100%', width: '100%' } },
  35: { pc: { height: '60%', width: '60%' }, mobile: { height: '60%', width: '60%' } },
  36: { pc: { height: '60%', width: '100%' }, mobile: { height: '100%', width: '100%' } },
37: { pc: { height: '60%', width: '100%' }, mobile: { height: '100%', width: '100%' } },
};
