...
class Player {
    constructor(player_data) {
        this.playerName = "名もなき闘士"; // プレイヤー名
        this.skill = [];
        this.name = [];
        this.type = [];
        this.speed = [];
        this.damage = [];
        this.scar = []; // 0:なし 1:あり 2:適用前
        this.limited = [];
        this.kage = [];
        this.gekirin = 0; // 0:なし 1:あり 2:適用前
        this.musou = 0;
        this.stan = 0;
        this.kakuran = 0;
        this.suijaku = 0;
        ...
        this.gyogun = 0; // 魚群フラグ
        this.tozoku = 0; // 盗賊フラグ
        this.extremeHpRemaining = []; // 極限の残りHP
        // 全角のスラッシュ「／」で分割
